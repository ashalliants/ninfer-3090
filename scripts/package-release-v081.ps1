...
$ChecksumPath = Join-Path $DistRoot 'SHA256SUMS-v0.8.1-windows.txt'
...
Copy-Item -LiteralPath (Join-Path $RepoRoot 'RELEASE_NOTES_0.8.1.md') -Destination $ProductRoot
