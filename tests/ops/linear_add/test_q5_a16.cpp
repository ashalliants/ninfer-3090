...
int q5_a16_conformance() {
    ...
    constexpr std::array<std::int32_t, 4> kK6144RouteStarts{3, 33, 104, 128};
    constexpr std::array<std::int32_t, 6> kK6144RouteInteriors{1, 16, 24, 64, 110, 256};
    ...
    constexpr std::array<std::int32_t, 5> kK17408RouteStarts{3, 33, 65, 104, 128};
    constexpr std::array<std::int32_t, 7> kK17408RouteInteriors{1, 16, 24, 40, 80, 110, 256};
    failures += ninfer::test::linear_add::run_shape(
        "Q5_A16 LinearAdd", WeightFormat::Q5G64F16S,
