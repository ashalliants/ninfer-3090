...
int q5_a16_conformance() {
    ...
    constexpr std::array<std::int32_t, 8> kK6144RouteStarts{3, 9, 11, 17, 25, 33, 104, 128};
    constexpr std::array<std::int32_t, 9> kK6144RouteInteriors{1, 5, 10, 14, 20, 28, 64, 110, 256};
    ...
    constexpr std::array<std::int32_t, 8> kK17408RouteStarts{3, 9, 11, 17, 25, 65, 104, 128};
    constexpr std::array<std::int32_t, 9> kK17408RouteInteriors{1, 5, 10, 14, 20, 40, 80, 110, 256};
    failures += ninfer::test::linear_add::run_shape(
        "Q5_A16 LinearAdd", WeightFormat::Q5G64F16S,
