...
checksum_path="$dist_root/SHA256SUMS-v0.8.1-linux.txt"
...
cp -- "$repo_root/VERSION" "$repo_root/LICENSE" "$repo_root/RELEASE_NOTES_0.8.1.md" "$product_root/"
