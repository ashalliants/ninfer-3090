...
cp -- "$repo_root"/scripts/{download-qwen38.sh,run-qwen38-c1.sh,run-qwen38-c8.sh,run-qwen38-vision.sh,download-qwen36-35b-vision.sh,run-qwen36-35b-vision.sh,run-qwen36-35b-a3b-c1-maxctx.sh} "$product_root/"
(
  cd -- "$product_root"
