...
checksum_path="$dist_root/SHA256SUMS-v0.7.0-linux.txt"
...
cp -- "$repo_root/VERSION" "$repo_root/LICENSE" "$repo_root/RELEASE_NOTES_0.7.0.md" "$product_root/"
